 ...
 * - **scale**(): Scale effect.
 * - **pulse**(): Fade in effect.
 * - **fadeOuLeft**(): Fade out left effect.
...
export class Effects {
   ...
   * 
   * ### Behaviour:
   * Generates CSS keyframes that start with the element at full transparency and no horizontal translation,
   * then transitions to full opacity while translating the element on the X-axis.
   * 
   * ### Parameters:
   ...
   * ```js
   * 
   * const fadeRightCSS = effects.fadeRight(20);S);
   * ```
   */
   ...
   * 
   * ### Behaviour:
   * Generates CSS keyframes that begin with the element offset along the Y-axis by a specified number of pixels and invisible,
   * and then transitions to no translation and full opacity.
   * 
   * ### Parameters:
   ...
   * ```js
   * 
   * const slideDownCSS = effects.slideDown(20);S);
   * ```
   */
   ...
   * ```js
   * 
   * const fadeOutRightCSS = effects.fadeOutRight(20);tCSS);
   * ```
   */
   ...
   * ```js
   * 
   * const fadeOutLeftCSS = effects.fadeOutLeft(20);CSS);
   * ```
   */
